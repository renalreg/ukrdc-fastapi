...
async def test_user(client):
    response = await client.get(f"{configuration.base_url}/system/user")
...
async def test_info(client):
    response = await client.get(f"{configuration.base_url}/system/info")
...
async def test_read_system_user_preferences(client):
    response = await client.get(f"{configuration.base_url}/system/user/preferences")
